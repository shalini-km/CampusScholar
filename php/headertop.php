...
<html class="no-js" lang="">
    <head>
        ...
        <meta name="description" content="Campus Scholar">
			...
			<div id="sticker">
				...
				<div class="menu ">
					...
					<ul>
						...
						<li><a href="upload.html"><i class="fa fa-sign-out" aria-hidden="true"></i> Certificate</a></li>
						...
						<?php if($user->get_faculty_session()){ ?>
								...
								<li><a href="upload1.html"><i class="fa fa-sign-out" aria-hidden="true"></i> Upload</a></li>
