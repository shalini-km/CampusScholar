...
<div class="all_student">
	<div class="search_st">
		...
		<!-- <div class="hdinfo" style="cursor: pointer;" onclick=""><h3>5 Best campus Scholar Names</h3></div> -->
		<a href="five_best_scholars.php" class="hdinfo" style="text-decoration: none;color: white;">Leader board</a>
		<div class="search">
